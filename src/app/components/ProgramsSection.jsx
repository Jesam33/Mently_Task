  ...
  const programs = [
    {
      ...
      description: "This program is hands-on guide designed for designers who want to master user interface and dashboards apps for their designs. The practical approach.",
      status: "Bootcamp",
      category: "Precious",
